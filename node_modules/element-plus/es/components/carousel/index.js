...
const _hoisted_1 = /* @__PURE__ */ createElementVNode("i", { class: "el-icon-arrow-left" }, null, -1);
const _hoisted_2 = [
  _hoisted_1
];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    _ctx.type === "card" ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$1, null, 512)), [
