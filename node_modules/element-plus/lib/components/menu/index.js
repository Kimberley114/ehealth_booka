...
var script$1 = vue.defineComponent({
  ...
  setup(props) {
    ...
    const showSubmenuTitleIcon = vue.computed(() => mode.value === "vertical" || !isFirstLevel.value);
    ...
    const fallbackPlacements = vue.computed(() => mode.value === "horizontal" && isFirstLevel.value ? ["bottom-start", "bottom-end", "top-start", "top-end", "right-start", "left-start"] : ["right-start", "left-start", "bottom-start", "bottom-end", "top-start", "top-end"]);
...
var script$2 = vue.defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const filteredSlot = vue.ref((_a = slots.default) == null ? void 0 : _a.call(slots));
          ...
          if (moreSlot == null ? void 0 : moreSlot.length) {
            filteredSlot.value = [
              ...
              vue.h(script$1, {
                ...
                title: () => vue.h("i", { class: ["el-icon-more", "el-sub-menu__icon-more"] }),
                default: () => moreSlot
              })
            ];
          }
  ...
  render() {
    const menu = vue.withDirectives(vue.h("ul", {
    ...
    }, [this.filteredSlot]), [[directives.Resize, this.handleResize]]);
    if (this.collapseTransition) {
      return vue.h(script, () => menu);
    }
    return menu;
  }
});
