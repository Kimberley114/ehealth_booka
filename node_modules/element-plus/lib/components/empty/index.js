...
const _hoisted_3$1 = { class: "el-empty__description" };
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
    vue.createElementVNode("div", {
      ...
      }, null, 8, _hoisted_2$1)) : vue.renderSlot(_ctx.$slots, "image", { key: 1 }, () => [
        vue.createVNode(_component_img_empty)
      ])
    ], 4),
    vue.createElementVNode("div", _hoisted_3$1, [
      _ctx.$slots.description ? vue.renderSlot(_ctx.$slots, "description", { key: 0 }) : (vue.openBlock(), vue.createElementBlock("p", _hoisted_4$1, vue.toDisplayString(_ctx.emptyDescription), 1))
    ]),
    _ctx.$slots.default ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$1, [
