        ...
        return vue.openBlock(), vue.createElementBlock("tr", { key }, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(row, (cell, key_) => {
            return vue.openBlock(), vue.createElementBlock("td", {
              ...
              vue.createElementVNode("div", null, [
                vue.createElementVNode("a", _hoisted_1$1, vue.toDisplayString(_ctx.t("el.datepicker.months." + _ctx.months[cell.text])), 1)
              ])
            ], 2);
          }), 128))
        ]);
    ...
    vue.createElementVNode("tbody", null, [
      vue.createElementVNode("tr", null, [
        vue.createElementVNode("td", {
          ...
          vue.createElementVNode("a", _hoisted_1$2, vue.toDisplayString(_ctx.startYear), 1)
        ], 2),
        vue.createElementVNode("td", {
...
const _hoisted_7$1 = { class: "el-date-picker__editor-wrap" };
    ...
    vue.createElementVNode("div", _hoisted_1$3, [
      ...
      vue.createElementVNode("div", _hoisted_4$1, [
        _ctx.showTime ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$1, [
          ...
          vue.withDirectives(vue.createElementVNode("span", _hoisted_7$1, [
            vue.createVNode(_component_el_input, {
        ...
        vue.withDirectives(vue.createElementVNode("div", {
          class: vue.normalizeClass(["el-date-picker__header", { "el-date-picker__header--bordered": _ctx.currentView === "year" || _ctx.currentView === "month" }])
        }, [
...
const _hoisted_9$2 = /* @__PURE__ */ vue.createElementVNode("span", { class: "el-icon-arrow-right" }, null, -1);
const _hoisted_10$2 = { class: "el-date-range-picker__editors-wrap is-right" };
const _hoisted_11$2 = { class: "el-date-range-picker__time-picker-wrap" };
const _hoisted_12$2 = { class: "el-date-range-picker__time-picker-wrap" };
const _hoisted_13$1 = { class: "el-picker-panel__content el-date-range-picker__content is-left" };
      ...
      vue.createElementVNode("div", _hoisted_4$2, [
        _ctx.showTime ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$2, [
          ...
          vue.createElementVNode("span", _hoisted_10$2, [
            ...
            vue.withDirectives(vue.createElementVNode("span", _hoisted_12$2, [
              vue.createVNode(_component_el_input, {
                size: "small",
                class: "el-date-range-picker__editor",
                disabled: _ctx.rangeState.selecting,
...
const _hoisted_8$3 = { class: "el-picker-panel__content el-date-range-picker__content is-right" };
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", _hoisted_1$5, [
      vue.renderSlot(_ctx.$slots, "sidebar", { class: "el-picker-panel__sidebar" }),
      _ctx.hasShortcuts ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$3, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.shortcuts, (shortcut, key) => {
          return vue.openBlock(), vue.createElementBlock("button", {
            key,
            type: "button",
      ...
      vue.createElementVNode("div", _hoisted_4$3, [
        vue.createElementVNode("div", _hoisted_5$3, [
          vue.createElementVNode("div", _hoisted_6$3, [
            ...
            }, null, 10, _hoisted_7$3)) : vue.createCommentVNode("v-if", true),
            vue.createElementVNode("div", null, vue.toDisplayString(_ctx.leftLabel), 1)
          ]),
        ...
        vue.createElementVNode("div", _hoisted_8$3, [
          vue.createElementVNode("div", _hoisted_9$3, [
            ...
            }, null, 10, _hoisted_10$3)) : vue.createCommentVNode("v-if", true),
            vue.createElementVNode("button", {
              type: "button",
              class: "el-picker-panel__icon-btn el-icon-d-arrow-right",
