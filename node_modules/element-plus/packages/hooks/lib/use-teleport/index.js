...
exports.default = (contentRenderer, appendToBody) => {
    const isTeleportVisible = vue_1.ref(false);
    ...
    const showTeleport = () => {
        ...
        if ($el !== null)
            return;
        $el = global_nodes_1.createGlobalNode();
    };
    const hideTeleport = () => {
        isTeleportVisible.value = false;
        if ($el !== null) {
            global_nodes_1.removeGlobalNode($el);
            $el = null;
        }
    };
    const renderTeleport = () => {
        return appendToBody.value !== true
            ...
            : isTeleportVisible.value
                ? [
                    vue_1.h(vue_1.Teleport, { to: $el }, contentRenderer()),
                ]
                : void 0;
    };
    vue_1.onUnmounted(hideTeleport);
    return {
        isTeleportVisible,
        showTeleport,
        hideTeleport,
