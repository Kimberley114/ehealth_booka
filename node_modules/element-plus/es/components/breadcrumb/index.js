import { defineComponent, ref, provide, onMounted, openBlock, createElementBlock, renderSlot, inject, getCurrentInstance, createElementVNode, normalizeClass, toDisplayString } from 'vue';
...
script.__file = "packages/components/breadcrumb/src/index.vue";
...
const _hoisted_1$1 = { class: "el-breadcrumb__item" };
const _hoisted_2 = {
  key: 1,
...
script$1.__file = "packages/components/breadcrumb/src/item.vue";

script.install = (app) => {
  app.component(script.name, script);
  app.component(script$1.name, script$1);
};
script.BreadcrumbItem = script$1;
const _Breadcrumb = script;
const ElBreadcrumb = _Breadcrumb;
const ElBreadcrumbItem = script$1;
